...
export const themes: Record<string, Theme> = {
  pine: {
    name: "pine", label: "Dennengroen", temp: "cool", dot: "#22C55E",
  ...
  steel: {
    name: "steel", label: "Staalblauw", temp: "cool", dot: "#38BDF8",
  ...
  militaryblue: {
    name: "militaryblue", label: "Legergroen", temp: "cool", dot: "#4ADE80",
  ...
  tin: {
    name: "tin", label: "Tingrijs", temp: "cool", dot: "#94A3B8",
  ...
  plum: {
    name: "plum", label: "Pruimpaars", temp: "warm", dot: "#C084FC",
  ...
  warmgray: {
    name: "warmgray", label: "Warm grijs", temp: "warm", dot: "#FB923C",
  ...
  beige: {
    name: "beige", label: "Beige", temp: "warm", dot: "#FCD34D",
