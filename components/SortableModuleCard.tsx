...
export default function SortableModuleCard({
  ...
  const controlBaseClass =
    "absolute z-10 flex h-10 w-10 origin-center transform items-center justify-center rounded-full text-white shadow-sm ring-[3px] ring-[#F7F9FC] transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]";
